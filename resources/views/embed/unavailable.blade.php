...
<head>
    ...
    <title>Video unavailable · Loops</title>
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .icon { margin: 0 auto 2rem; width: 4rem; height: 4rem; color: var(--fg); display: block; }
        .title { font-size: 1.5rem; font-weight: 700; margin: 0 0 1rem; line-height: 1.25; }
