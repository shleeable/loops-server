                    ...
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                        ...
                        <DialogPanel
                            ...
                            <div class="p-6">
                                ...
                                <div v-if="loading && availableVideos.length === 0" class="text-center py-8">
                                    <Spinner />
                                ...
                                <div v-else ref="scrollContainer" @scroll="handleScroll"
                                    class="max-h-96 overflow-y-auto space-y-2 scroll-smooth">
                                    <div v-for="video in availableVideos" :key="video.id" @click="toggleVideo(video.id)"
                                    ...
                                    <div v-if="loading && availableVideos.length > 0" class="text-center py-4">
                                ...
                                <div
                                    ...
                                    <div class="flex space-x-3">
                                        <button type="button" @click="closeModal" :disabled="adding"
