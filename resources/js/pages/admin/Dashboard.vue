    ...
    <div class="space-y-6">
        ...
        <div v-else class="space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                <MiniMetric
                    label="Active Today"
                    :value="dashboardData.metrics.active_today"
                />
                <MiniMetric
                    label="Comments"
                ...
                <MiniMetric
                    label="Likes"
                    :value="formatCount(dashboardData.metrics.total_likes)"
                />
                <MiniMetric
                    label="Followers"
                ...
                <MiniMetric
                    label="Storage Used"
                    :value="dashboardData.metrics.storage_used"
                />
            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            >
                                {{
                                    formatCount(
                                        dashboardData.federation.remote_videos,
                                    )
                                }}
                            </span>
                        </div>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            >
                                {{
                                    formatCount(
                                        dashboardData.federation.remote_replies,
                                    )
                                }}
                            </span>
                        </div>
...
const initUserGrowthChart = () => {
    ...
    userGrowthInstance = echarts.init(
...
const initEngagementChart = () => {
    ...
    engagementInstance = echarts.init(
        engagementChart.value,
        isDarkMode.value ? "dark" : "light",
    );
...
const initContentDistChart = () => {
    ...
    contentDistInstance = echarts.init(
        contentDistChart.value,
        isDarkMode.value ? "dark" : "light",
    );
