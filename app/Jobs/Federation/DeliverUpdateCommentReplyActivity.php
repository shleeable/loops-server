...
class DeliverUpdateCommentReplyActivity implements ShouldBeUnique, ShouldQueue
{
    ...
    {
        return "deliver-comment-reply-update-{$this->comment->id}-{$this->inboxUrl}";
    }
    ...
    public function handle(): void
    {
        ...
        $activity = UpdateActivityBuilder::buildForComment($actor, $comment);
